        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><h6>The Bareilly Food Waale</h6><img src="images/materialize-logo.png" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
...
<table>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
      <span>Copyright © 2021 <a class="grey-text text-lighten-4" href="#" target="_blank">Bareilly Food Waale</a> All rights reserved.</span>
        <span class="right"> BCA Major Project <a class="grey-text text-lighten-4" href="#">Invertis University Bareilly</a></span>
        </div>
    </div>
    <!-- END FOOTER -->
